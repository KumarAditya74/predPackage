...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            categorical_cols = ['Knows ML','Knows DSA','Knows Python','Knows JavaScript','Was in Coding Club']
           ...
           # 'Knows ML', 'CGPA', 'No. of DSA questions', 'Knows JavaScript', 'Knows Python', 'Was in Coding Club', 'No. of backlogs', 'Knows DSA'
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            target_column_name = 'Placement Package'
